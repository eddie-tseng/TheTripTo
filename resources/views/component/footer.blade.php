    ...
    <div class="row">
        ...
        <div class="social-media col-md-4 mt-4">
            ...
            <div class="row mx-0 mt-4">
                <a href="#"><img class="img" style="" src={{url("/img/site/fb.png")}} alt=""></a>
                <a href="#"><img class="img ml-4" style="" src={{url("/img/site/ig.png")}} alt=""></a>
            </div>
            <p class="text-white mt-4" style="font-size:0.75rem">COPYRIGHT © 2019 THE TRIP TO [&nbsp;&nbsp;&nbsp;&nbsp;] All rights reserved.
            </p>
