        ...
        <div class="modal-content">
            <div class="modal-bady">
                ...
                <div class="container">
                    ...
                    <div class="log-in row justify-content-center">
                        <form action="/user/sign-in" method="post">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row justify-content-around mt-4">
                                    <a href={{url("/user/sign-up")}} type="button" class="px-4 btn button-dark text-white">註冊</a>
                                    <button id="sign-in" type="submit" class="px-4 btn button-dark">登入</button>
                                    {{-- <button id="trigger-submit" type="submit" class="px-4" hidden>234</button> --}}
                                </div>
                            </div>
                            {{ csrf_field() }}
                        </form>
                    ...
                    <div class="fast-log-in row justify-content-center text-md-center" hidden>
                        ...
                        <hr style="height:1px; background-color:#23293132;">
                        <div class="default-account row justify-content-center text-md-center mb-4">
                            <form  action="/user/sign-in" method="post">
