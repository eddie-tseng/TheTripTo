        ...
        <div class="navbar-nav ml-auto mr-2" style="display: inline-block;">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <ul class="navbar-nav float-right text-right">
                    {{-- <li class="nav-item"> @yield('order')</li> --}}
                    @if(session()->has('user_id'))
                    <li class="nav-item"><a href="/user/{{session()->get('user_id')}}" class="nav-link text-white">會員</a></li>
                    <li class="nav-item"><a href="/user/sign-out" class="nav-link text-white">登出</a></li>
                    @else
                    <li class="nav-item"><a class="nav-link text-white" data-toggle="modal" data-target="#account-modal">註冊&nbsp;&nbsp;|&nbsp;&nbsp;登入</a>
                    </li>
                    {{-- <li class="nav-item"><a href="/user/sign-in" class="nav-link">註冊</a></li> --}}
                    @endif
