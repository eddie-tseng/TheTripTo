...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img class="d-block" src={{url("/img/site/banner_1.jpg")}} alt="First slide">
        </div>
        <div class="carousel-item">
            <img class="d-block" src={{url("/img/site/banner_2.jpg")}} alt="Second slide">
        </div>
        <div class="carousel-item">
            <img class="d-block" src={{url("/img/site/banner_3.jpg")}} alt="Third slide">
        </div>
