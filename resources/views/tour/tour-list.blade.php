...
<div class="container-fluid w-75">
    <form action="/tour/tour-list/search/" method="get" class="filter">
        @switch (array_key_first($page))
            ...
            @case('city')
                ...
                <p class="info mb-2"><a href="/" class="font-weight-bold">首頁</a>&nbsp;|&nbsp;
                    <a href="/tour/tour-list/search/?country={{$page['country']}}&sort=default" class="font-weight-bold">{{$page['country']}}</a>&nbsp;|&nbsp;
                    {{$page['city']}}</p>
                @break
            @default
        ...
        <div class="row justify-content-around mx-0">
            <div class="col-sm-3">
                <div class="row">
                    <div class="col-sm-12 py-4 border">
                        <p class="pl-4 font-weight-bold">已選擇</h5>
                            ...
                            @foreach($initial_options as $filter => $options)
                                ...
                                @endif
                            <hr style="height:1px; left:0; background-color:#23293132;">
                            <p class="pl-4 font-weight-bold">{{$filter}}</h5>
                                @foreach ( $options as $option)
                ...
                <div class="row ml-0">
                    ...
                    <a href="/tour/{{$tour->id}}">
                        <div class="row mb-4 border mx-0">
                            ...
                            <div class="col-sm-8 d-flex flex-column justify-content-between pr-2">
